...
export function DeleteModal({ isOpen, recordTitle, onClose, onConfirm }: DeleteModalProps) {
        ...
        <div className="p-6">
          ...
          <div className="mb-4">
            <p className="text-sm text-gray-600 mb-2">
              Você está prestes a excluir o seguinte registro:
            </p>
            <div className="bg-red-50 border border-red-200 rounded-lg p-3">
              <p className="text-sm font-semibold text-gray-900">{recordTitle}</p>
            </div>
          </div>
            ...
            <div className="flex gap-2">
              ...
              <div>
                ...
                <p className="text-xs text-yellow-800 mt-1">
                  Esta ação não pode ser desfeita. O documento anexado também será excluído permanentemente.
                </p>
              </div>
            </div>
          </div>

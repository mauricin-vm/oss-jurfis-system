...
export function DeleteModal({ isOpen, memberName, onClose, onConfirm }: DeleteModalProps) {
          ...
          <div className="space-y-4">
            ...
            <div>
              <p className="text-sm text-gray-700 mb-2">
                Você está prestes a excluir o seguinte membro:
              </p>
              ...
              <div className="flex gap-2">
                ...
                <div>
                  ...
                  <p className="text-xs text-yellow-800 mt-1">
                    Esta ação não poderá ser desfeita e o membro será removido permanentemente.
                  </p>
                </div>
              </div>
            </div>

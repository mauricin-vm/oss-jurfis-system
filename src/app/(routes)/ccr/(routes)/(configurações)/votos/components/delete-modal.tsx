...
export function DeleteModal({ isOpen, decisionName, onClose, onConfirm }: DeleteModalProps) {
          ...
          <div className="space-y-4">
            ...
            <div>
              <p className="text-sm text-gray-700 mb-2">
                Você está prestes a excluir o seguinte voto:
              </p>
              <div className="bg-red-50 border border-red-200 rounded-lg p-3">
                <p className="text-sm font-semibold text-gray-900">{decisionName}</p>
              </div>
            </div>
              ...
              <div className="flex gap-2">
                ...
                <div>
                  ...
                  <p className="text-xs text-yellow-800 mt-1">
                    Esta ação não poderá ser desfeita e o voto será removido permanentemente.
                  </p>
                </div>
              </div>
            </div>

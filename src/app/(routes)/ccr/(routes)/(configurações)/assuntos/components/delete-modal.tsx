...
export function DeleteModal({ isOpen, subjectName, onClose, onConfirm }: DeleteModalProps) {
      ...
      >
        <div className="p-6">
          ...
          <div className="space-y-4">
            {/* Assunto a ser excluído */}
            <div>
              <p className="text-sm text-gray-700 mb-2">
                Você está prestes a excluir o seguinte assunto:
              </p>
              ...
              <div className="flex gap-2">
                ...
                <div>
                  ...
                  <p className="text-xs text-yellow-800 mt-1">
                    Esta ação não poderá ser desfeita e o assunto será removido permanentemente.
                  </p>
                </div>
              </div>
            </div>
